...
(function () {
  ...
  style.textContent = [
    ...
    '  background:linear-gradient(150deg,#F4F2EA 0%,#E9F0EA 55%,#F6F4EC 100%);',
    '}',
    '.auth-card {',
    ...
    '  box-shadow:0 16px 60px rgba(20,60,45,0.13),0 4px 16px rgba(20,60,45,0.07);',
    '  text-align:center;',
    '  overflow:hidden;',
    '}',
    /* 装飾円リング */
    ...
    '  border-radius:50%;',
    '  border:2px solid rgba(46,125,99,0.2);',
    '  box-shadow:',
    '    0 0 0 2.5rem rgba(46,125,99,0.07),',
    '    0 0 0 5rem  rgba(46,125,99,0.045),',
    '    0 0 0 7.5rem rgba(46,125,99,0.025);',
    '  pointer-events:none;',
    '}',
    '.auth-logo {',
    '  font-size:2.8rem;',
    ...
    '}',
    '.auth-field:focus-within { border-color:#4D9B77; }',
    '#auth-input {',
    '  width:100%;',
    '  border:none;',
    '  outline:none;',
    ...
    '  font-family:inherit;',
    '}',
    '#auth-input::placeholder { color:#98A49C; }',
    '#auth-btn {',
    '  display:block;',
    '  width:100%;',
    '  margin-top:0.9rem;',
    ...
    '}',
    '#auth-btn:hover { background:#2E7D63; }',
