...
def make_taiseicheck():
    ...
    items=[
        ["福祉・介護職員等処遇改善加算（Ⅰ）","基本報酬×サービス別加算率","毎年4/15","毎年6月〜","計画書提出・職場環境整備確認（旧3加算は一本化）","毎年更新（7/31実績報告）"],
        ["福祉専門職員配置等加算（Ⅰ）","15単位/日","","","有資格者比率25%以上を確認","職員変更時に再確認"],
        ["24時間対応体制加算","ロ6,520円/イ6,800円（月）","","","24時間連絡・緊急訪問体制整備（イは負担軽減の取組2項目以上）","体制変更時に届出変更必要"],
