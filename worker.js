...
async function handleOorasuComment(request, env, ctx) {
  ...
  const system = 'あなたは麻雀のコーチです。次に渡す【解説】は計算済みで内容は正しいものです。これを、コーチが話しかけるように自然で前向きな日本語（100〜160字）に言い換えてください。\n絶対厳守:\n・事実・数値・パーセント・着順・打点・ロン/ツモ・親/子を一切変えない、足さない、消さない。\n・新しい情報や具体的な点数、狙う役などを勝手に加えない（元の解説にあるものはOK）。\n・言い回しと語り口だけを整える。前置き・復唱・自己説明はしない。言い換えた本文だけを書く。';
